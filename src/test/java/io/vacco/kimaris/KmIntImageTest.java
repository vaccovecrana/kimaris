...
public class KmIntImageTest {
  ...
  public static final double[][] in0 = new double[][] {
      { 5, 2, 5, 2 },
      { 3, 6, 3, 6 },
      { 5, 2, 5, 2 }
  };
  public static final double[][] out0 = new double[3][4];

  public static final double[][] imgIn = new double[][] {
  ...
  public static final double[][] imgOut = new double[8][10];
